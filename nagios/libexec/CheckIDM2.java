...
/*
	$Id: CheckIDM2.java,v 1.1 2010/04/22 23:35:04 evaughn Exp $
	$Date: 2010/04/22 23:35:04 $
*/

public class CheckIDM2 {

	static final String version	= "$Id: CheckIDM2.java,v 1.1 2010/04/22 23:35:04 evaughn Exp $";
	...
	public static void main( String[] args ) {
		...
		try {
			...
			UserIdentityClientHome home = (UserIdentityClientHome) PortableRemoteObject.narrow(
				ctx.lookup( "ejb/IDMUserIdentityClientEJB" ),
...
//			e.printStackTrace();
		...
		} catch( com.tomax.idm.server.UnableToPerformException e ) {
			result = "Error performing remote function call " + jnpUrl + " [UnableToPerformException]: " + e.toString();
			return_code = 2;
			System.out.print( result );	
			System.exit( return_code );
		}
