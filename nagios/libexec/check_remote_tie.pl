...
#
# $Id: check_remote_tie.pl,v 1.1 2010/04/13 20:51:02 evaughn Exp $
...
my $cmd;        # Comes directly from the 'tie-service' property in thresholds file
...
my @required    = ( "username", "tie-servcie" );
